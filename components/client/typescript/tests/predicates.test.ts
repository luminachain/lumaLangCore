...
import { LumalanghookEventObserver, EventObserverOptions, EventObserverPredicate } from '../src';
...
describe('predicates', () => {
  ...
  let server: LumalanghookEventObserver;
  ...
  beforeEach(() => {
    ...
    observer = {
      ...
      wait_for_lumalanghook_node: true,
      validate_lumalanghook_payloads: false,
      predicate_disk_file_path: './tmp',
      node_type: 'lumaLang',
    };
    server = new LumalanghookEventObserver(observer, {
  ...
  describe('pre-stored', () => {
    ...
    test('resumes active predicate', async () => {
      mockClient
        .intercept({
          path: '/v1/lumalanghooks/e2777d77-473a-4c1d-9012-152deb36bf4c',
          method: 'GET',
        })
    ...
    test('re-registers dead predicate', async () => {
      ...
      mockClient
        .intercept({
          path: '/v1/lumalanghooks/stacks/e2777d77-473a-4c1d-9012-152deb36bf4c',
          method: 'DELETE',
        })
        .reply(200);
      mockClient
