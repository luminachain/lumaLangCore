...
use crate::lumalanghooks::stacks::{StacksLumalanghookSpecification, StacksLumalanghookSpecificationNetworkMap, StacksContractCallBasedPredicate, StacksContractDeploymentPredicate, StacksPredicate, StacksPrintEventBasedPredicate};
use crate::lumalanghooks::types::*;
use crate::lumalanghooks::types::HttpHook;
...
lazy_static! {
    ...
    static ref ALL_INVALID_SPEC: StacksLumalanghookSpecification = StacksLumalanghookSpecification::new(INVALID_PREDICATE.clone(), INVALID_HOOK_ACTION.clone());
    static ref ALL_INVALID_SPEC_NETWORK_MAP: LumalanghookSpecificationNetworkMap = 
...
fn it_validates_stacks_lumalanghook_specs(
    predicate: &LumalanghookSpecificationNetworkMap,
    expected_err: String,
) {
    if let Err(e) = predicate.validate() {
