use super::*;
use crate::lumalanghooks::{bitcoin::InscriptionFeedData, types::LumalanghookSpecificationNetworkMap};
...
lazy_static! {
    ...
    static ref ALL_INVALID_SPEC: BitcoinLumalanghookSpecification = BitcoinLumalanghookSpecification::new(INVALID_TXID_PREDICATE.clone(), INVALID_HOOK_ACTION.clone());
...
fn it_validates_bitcoin_lumalanghook_specs(
