...
use crate::lumalanghooks::stacks::try_decode_clarity_value;
...
impl NewEvent {
    pub fn into_lumalanghook_event(&self) -> Result<StacksTransactionEvent, String> {
...
pub fn standardize_stacks_block(
    ...
    for tx in block.transactions.iter() {
        ...
        let events = tx_events
            .iter()
            .map(|e| e.into_lumalanghook_event())
