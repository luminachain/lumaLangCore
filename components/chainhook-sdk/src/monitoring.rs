...
impl PrometheusMonitoring {
    pub fn new() -> PrometheusMonitoring {
        ...
        let stx_highest_block_appended = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_highest_block_appended",
            "The highest Stacks block successfully appended to a LumaLang node fork.",
        );
        let stx_highest_block_received = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_highest_block_received",
            "The highest Stacks block received by the LumaLang node from the Stacks node.",
        );
        let stx_highest_block_evaluated = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_highest_block_evaluated",
        ...
        let stx_canonical_fork_lag = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_canonical_fork_lag",
        ...
        let stx_block_evaluation_lag = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_block_evaluation_lag",
        ...
        let stx_last_reorg_timestamp = PrometheusMonitoring::create_and_register_int_gauge(
            &registry,
            "lumalanghook_stx_last_reorg_timestamp",
            "The timestamp of the latest Stacks reorg ingested by the LumaLang node.",
        );
        let stx_last_reorg_applied_blocks = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_last_reorg_applied_blocks",
        ...
        let stx_last_reorg_rolled_back_blocks =
            PrometheusMonitoring::create_and_register_uint64_gauge(
                &registry,
                "lumalanghook_stx_last_reorg_rolled_back_blocks",
        ...
        let stx_last_block_ingestion_time = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_last_block_ingestion_time",
            "The time that the LumaLang node last ingested a Stacks block.",
        );
        let stx_registered_predicates = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_registered_predicates",
            "The number of Stacks predicates that have been registered by the LumaLang node.",
        );
        let stx_deregistered_predicates = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_stx_deregistered_predicates",
            "The number of Stacks predicates that have been deregistered by the LumaLang node.",
        );

        // bitcoin metrics
        let btc_highest_block_appended = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_highest_block_appended",
            "The highest Bitcoin block successfully appended to a LumaLang node fork.",
        );
        let btc_highest_block_received = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_highest_block_received",
            "The highest Bitcoin block received by the LumaLang node from the Bitcoin node.",
        );
        let btc_highest_block_evaluated = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_highest_block_evaluated",
        ...
        let btc_canonical_fork_lag = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_canonical_fork_lag",
        ...
        let btc_block_evaluation_lag = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_block_evaluation_lag",
        ...
        let btc_last_reorg_timestamp = PrometheusMonitoring::create_and_register_int_gauge(
            &registry,
            "lumalanghook_btc_last_reorg_timestamp",
            "The timestamp of the latest Bitcoin reorg ingested by the LumaLang node.",
        );
        let btc_last_reorg_applied_blocks =
            PrometheusMonitoring::create_and_register_uint64_gauge(
                &registry,
                "lumalanghook_btc_last_reorg_applied_blocks",
        ...
        let btc_last_reorg_rolled_back_blocks =
            PrometheusMonitoring::create_and_register_uint64_gauge(
                &registry,
                "lumalanghook_btc_last_reorg_rolled_back_blocks",
        ...
        let btc_last_block_ingestion_time = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_last_block_ingestion_time",
            "The time that the LumaLang node last ingested a Bitcoin block.",
        );
        let btc_registered_predicates = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_registered_predicates",
            "The number of Bitcoin predicates that have been registered by the LumaLang node.",
        );
        let btc_deregistered_predicates = PrometheusMonitoring::create_and_register_uint64_gauge(
            &registry,
            "lumalanghook_btc_deregistered_predicates",
            "The number of Bitcoin predicates that have been deregistered by the LumaLang node.",
        );
