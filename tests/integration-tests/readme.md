# automate-lumalanghooks
automate-lumalanghooks is a npm script for automation testing of [lumaLang](https://github.com/luminachain/lumaLang/blob/5791379655fba786abf6e265311c0d789a8722e5/docs/getting-started.md)

### Prerequisites
- npm installed and Node v16.*
- [ngrok](https://dev.to/ibrarturi/how-to-test-webhooks-on-your-localhost-3b4f)
- [lumaLang](https://github.com/luminachain/lumaLang/blob/5791379655fba786abf6e265311c0d789a8722e5/docs/getting-started.md)
...
### Bitcoin
Run the bitcoind with `./bitcoind -rpcuser=root -rpcpassword=root`. Set this user and root in `LumaLang.toml` file and run the command as `lumaLang predicates scan /home/user/tests/stacks-predicates/transaction/transaction-bitcoin-file.json --config-path=./LumaLang.toml`
